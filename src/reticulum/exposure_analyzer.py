...
class ExposureAnalyzer:
    ...
    def _analyze_exposure(self, values: Dict[str, Any], chart_name: str, chart_dir: Path, repo_path: Path, env_name: str = "base") -> List[Dict[str, Any]]:
    ...
    def _analyze_template_exposure(self, template: Dict[str, Any], chart_name: str, chart_dir: Path, repo_path: Path) -> List[Dict[str, Any]]:
    ...
    def _create_container_info(self, chart_name: str, gateway_type: str, host: str, chart_dir: Path, repo_path: Path, score: int, level: str, env_name: str = "base") -> Dict[str, Any]:
    ...
    def filter_redundant_base_containers(self, containers: List[Dict[str, Any]], chart_name: str) -> List[Dict[str, Any]]:

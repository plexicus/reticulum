...
class DOTBuilder:
    ...
    def build_diagram(self, containers: List[Dict[str, Any]]) -> str:
        ...
        # Add internet node
        dot_lines.append('    Internet [label="Internet", shape=ellipse, fillcolor="#ff6b6b"];')
        ...
        for container in high_containers:
            ...
            dot_lines.append(f'    {node_name} [label="{label}", fillcolor="{high_color}"];')
